...
.metric{background:var(--surface);border:1px solid var(--border);border-radius:var(--radius);padding:1.25rem 1.35rem;transition:border-color .2s,box-shadow .2s}
.metric:hover{border-color:var(--border-soft);box-shadow:0 4px 12px rgba(0,0,0,.06)}
.metric-label{font-size:11px;font-weight:600;letter-spacing:.05em;text-transform:uppercase;color:var(--muted);margin-bottom:8px}
.metric-value{font-size:1.7rem;font-weight:700;letter-spacing:-0.03em;line-height:1.15;color:var(--text)}
.metric-value .unit{font-size:12px;font-weight:500;color:var(--muted);margin-left:3px}
.input-light{background:#fff;border:1px solid var(--border);color:var(--text);border-radius:var(--radius-sm);font-size:13px;transition:border-color .2s,box-shadow .2s}
.input-light:focus{outline:none;border-color:var(--accent);box-shadow:0 0 0 3px var(--accent-soft)}
.input-light::placeholder{color:var(--muted)}
...
.btn-ghost{background:#fff;color:var(--muted);border:1px solid var(--border);padding:8px 14px}
.btn-ghost:hover{background:var(--surface2);color:var(--text)}
.btn-export{background:var(--text);color:#fff;font-weight:600;padding:8px 16px}
.btn-export:hover{opacity:.9}
.btn-invoice{background:var(--accent);color:#fff;font-weight:600;padding:8px 16px}
.btn-invoice:hover{background:var(--accent-h)}
.btn-toggle{background:#fff;color:var(--accent);border:1px solid var(--border);padding:7px 14px;font-size:12.5px;font-weight:500;border-radius:var(--radius-sm);cursor:pointer;display:inline-flex;align-items:center;gap:6px}
.btn-toggle:hover{background:var(--accent-soft);border-color:var(--accent)}
.table-wrap{overflow-x:auto;-webkit-overflow-scrolling:touch}
table{width:100%;border-collapse:collapse}
thead tr{background:var(--surface2)}
th{font-size:11px;font-weight:600;letter-spacing:.05em;text-transform:uppercase;color:var(--muted);text-align:left;padding:12px 20px}
td{padding:13px 20px;font-size:13.5px;border-top:1px solid var(--border);color:var(--text)}
tbody tr{transition:background .12s}
tbody tr:hover{background:#f8fafc}
.status-billable{display:inline-block;background:rgba(79,70,229,.1);color:#4f46e5;font-size:11px;font-weight:600;padding:3px 9px;border-radius:6px}
.status-non{display:inline-block;background:#f1f5f9;color:var(--muted);font-size:11px;font-weight:600;padding:3px 9px;border-radius:6px}
.site-header{background:rgba(255,255,255,.9);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);border-bottom:1px solid var(--border);position:sticky;top:0;z-index:30}
...
.login-card{background:var(--surface);border:1px solid var(--border);border-radius:16px;box-shadow:0 10px 40px rgba(0,0,0,.08);padding:2.5rem;width:100%;max-width:400px}
...
.inv-modal{position:fixed;inset:0;z-index:1000;display:none;overflow-y:auto;background:rgba(15,23,42,.45);backdrop-filter:blur(4px)}
.inv-modal.open{display:block}
.inv-panel{max-width:900px;margin:2rem auto;background:#fff;border-radius:16px;box-shadow:0 25px 50px -12px rgba(0,0,0,.25);overflow:hidden}
.inv-toolbar{display:flex;align-items:center;justify-content:space-between;padding:14px 24px;border-bottom:1px solid var(--inv-border);background:#f8fafc}
...
.btn-pdf{display:inline-flex;align-items:center;gap:7px;background:#0f172a;color:#fff;font-size:13px;font-weight:600;padding:9px 16px;border:none;border-radius:8px;cursor:pointer}
...
.inv-form input,.inv-form select{width:100%;padding:9px 12px;border:1px solid #e2e8f0;border-radius:8px;font-size:13px;color:#0f172a;background:#fff}
.inv-form input:focus,.inv-form select:focus{outline:none;border-color:#4f46e5;box-shadow:0 0 0 3px rgba(79,70,229,.15)}
@media print{
      ...
      <div class="card p-4">
        <div class="flex flex-wrap items-end gap-3">
          <div class="flex-1 min-w-[160px]">
            ...
            <input id="af" type="text" placeholder="ANI, state or date..." class="input-light w-full px-3.5 py-2.5" oninput="applyFilters()">
          </div>
          <div>
            <label class="block text-[11px] font-medium mb-1.5" style="color:var(--muted)">From</label>
            <input id="ag" type="date" class="input-light px-3.5 py-2.5" onchange="applyFilters()">
          </div>
          <div>
            <label class="block text-[11px] font-medium mb-1.5" style="color:var(--muted)">To</label>
            <input id="ah" type="date" class="input-light px-3.5 py-2.5" onchange="applyFilters()">
          </div>
          <div>
            <label class="block text-[11px] font-medium mb-1.5" style="color:var(--muted)">Status</label>
            <select id="ai" class="input-light px-3.5 py-2.5" onchange="applyFilters()">
